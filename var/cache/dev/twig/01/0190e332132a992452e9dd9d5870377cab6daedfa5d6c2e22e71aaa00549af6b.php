...
class __TwigTemplate_0e550439539cdf733cc9ce1bef533817ad81f3225d31b54c206c63bb477ac40f extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("admin/index.html.twig", "admin/user/show.html.twig", 1);
...
<div class=\"container-fluid\">
    <div class=\"fade-in\">
        ...
        // line 14
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("edit_user", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 14, $this->source); })()), "id", [], "any", false, false, false, 14)]), "html", null, true);
        echo "\">
        ...
        echo "</em>
                            ...
                            <div class=\"row\">
                                ...
                                <div class=\"col-sm-9\">
                                    <em>";
        // line 49
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 49, $this->source); })()), "roles", [], "any", false, false, false, 49), 0, [], "array", false, false, false, 49), "html", null, true);
        echo "</em>
                                </div>
                            </div>
                            <hr>
                            <div class=\"row\">
                                ...
                                <div class=\"col-sm-9\">
                                    <em>";
        // line 58
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 58, $this->source); })()), "lastName", [], "any", false, false, false, 58), "html", null, true);
        echo "</em>
                                </div>
                            </div>
                        </div>
...
";
        ...
        $context["entity"] = "user";
        // line 87
        $this->loadTemplate("admin/back_to_list_card.html.twig", "admin/user/show.html.twig", 87)->display($context);
        // line 88
        echo "
";
    ...
    {
        return array (  187 => 88,  185 => 87,  183 => 86,  152 => 58,  140 => 49,  128 => 40,  116 => 31,  105 => 22,  98 => 14,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "admin/user/show.html.twig", "/Users/eddysalibi/Desktop/Dev/ESGI/Symphony/ratrappage/tripeDream.github.io/templates/admin/user/show.html.twig");
    }
}
