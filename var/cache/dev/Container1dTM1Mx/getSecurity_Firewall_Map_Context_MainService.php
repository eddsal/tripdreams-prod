...
class getSecurity_Firewall_Map_Context_MainService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c->addListener('security.interactive_login', [0 => function () use ($container) {
            return ($container->privates['App\\EventListener\\LoginListener'] ?? $container->load('getLoginListenerService'));
